...
class ImageGql extends Model
{
    ...
    static public function getType(): Type
    {
        ...
        $type = GqlEntityRegistry::getEntity($typeName)
          ...
          'description' => 'The interface implemented by OnePlugin Pro Image type.',
          ]));
    ...
    {
        $srcset = '';
        $assets = OnePluginProOptimizedImage::find()->where(['assetId' => $this->iconData['id']])->all();
