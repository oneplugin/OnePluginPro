...
{
    private $defaultSize = ["animatedIcons" => ["width" => "256px","height" => "256px"],"svg" => ["width" => "256px","height" => "256px"],"imageAsset" => ["width" => "100%","height" => "100%"]];

    public function render(OnePluginProAsset $asset, array $options): array{

        return [Html::tag('div', Craft::t('one-plugin-pro', 'No renderer found for type ' . $asset->iconData['type'])),false];
    }

    public function includeAssets(){
        
    }
    protected function normalizeOptionsForSize(OnePluginProAsset $asset,array $options){
