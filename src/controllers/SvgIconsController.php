...
use oneplugin\onepluginpro\helpers\EvalMath;
use oneplugin\onepluginpro\elements\SVGIconPack;
...
class SvgIconsController extends Controller
{
    ...
    public function actionIndex(): Response
    {
        ...
        return $this->renderTemplate('one-plugin-pro/svgicons/index', array_merge(
                [
                    'plugin' => $this->plugin,
                    'settings' => $settings
                ],
    ...
    public function actionNew(): Response
    {
        ...
        return $this->renderTemplate('one-plugin-pro/svgicons/_new', array_merge(
            [
                'plugin' => $this->plugin,
    ...
    public function actionSave(): ?Response
    {
        ...
        if( !$success){
            ...
            $transaction->commit();
            Craft::$app->getSession()->setNotice(Craft::t('one-plugin-pro', 'SVG Icon Pack added successfully.'));
            $json = [
                'success' => true,
            ];
            return $this->asJson($json);
    ...
    public function actionEdit($iconPackId){
        ...
        $icons = OnePluginProSVGIcon::find()->where(['category' => $svgIconPack->category])->all();
        $m = new EvalMath;
        ...
        return $this->renderTemplate('one-plugin-pro/svgicons/_edit', array_merge(
            [
                'plugin' => $this->plugin,
